...
func main() {
	...
	HandleError(nil, err)
	html, err := ioutil.ReadFile(path.Join(os.Getenv("GOPATH"), "src/github.com/goclub/session/internal/example/app_header/index.html"))
	HandleError(nil, err)
	http.HandleFunc("/", func(writer http.ResponseWriter, request *http.Request) {
		...
		session, err := sessHub.GetSessionByHeader(ctx, writer, request.Header)
